...
{
    public static class MessageBoxButtonsString
    {
        public static string Abort => MessageBoxManager.Abort.TrimStart('&');
        public static string Cancel => MessageBoxManager.Cancel.TrimStart('&');
        public static string Ignore => MessageBoxManager.Ignore.TrimStart('&');
        public static string No => MessageBoxManager.No.TrimStart('&');
        public static string OK => MessageBoxManager.OK.TrimStart('&');
        public static string Retry => MessageBoxManager.Retry.TrimStart('&');
        public static string Yes => MessageBoxManager.Yes.TrimStart('&');
    }
}
